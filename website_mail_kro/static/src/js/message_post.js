odoo.define('website_mail_kro.thread', function(require) {
    'use strict';
    ...
    // load qweb template
    ajax.loadXML('/website_mail_kro/static/src/xml/chatter_message.xml', qweb);
    ...
    var WebsiteMailThread = Widget.extend({
        ...
        prepend_message: function(message_data){
            var msg = qweb.render('website_mail_kro.thread_message', message_data);
