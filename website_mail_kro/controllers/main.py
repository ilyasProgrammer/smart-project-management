...
class WebsiteMail(http.Controller):
    ...
    @http.route(['/website_mail_kro/follow'], type='json', auth="public", website=True)
    ...
    @http.route(['/website_mail_kro/is_follower'], type='json', auth="public", website=True)
    ...
    @http.route(['/website_mail_kro/post/json'], type='json', auth='public', website=True)
    ...
    @http.route(['/website_mail_kro/post/post'], type='http', methods=['POST'], auth='public', website=True)
