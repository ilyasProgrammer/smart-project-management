...
class Task(models.Model):
    ...
    job_aim_id = fields.Many2one(related='job_id.aim_id', string=u'Цель', readonly=True, help=u'Цель задачи')
    ...
    problem_project_id = fields.Many2one(related='job_aim_id.problem_id.kro_project_id', string=u'Проект', readonly=True)
    aim_project_id = fields.Many2one(related='job_aim_id.project_id', string=u'Проект', readonly=True)
