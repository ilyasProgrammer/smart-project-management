...
class Forum(models.Model):
    ...
    default_post_type = fields.Selection([
        ...
        ('link', 'Link')],
        string='Default Post', required=True, default='discussion')
    allow_question = fields.Boolean('Questions', help="Users can answer only once per question. Contributors can edit answers and mark the right ones.", default=False)
    ...
    # karma generation
    karma_gen_question_new = fields.Integer(string='Asking a question', default=1)
    ...
    # karma-based actions
    karma_ask = fields.Integer(string='Ask questions', default=1)
    karma_answer = fields.Integer(string='Answer questions', default=1)
    ...
    karma_upvote = fields.Integer(string='Upvote', default=1)
    karma_downvote = fields.Integer(string='Downvote', default=1)
    karma_answer_accept_own = fields.Integer(string='Accept an answer on own questions', default=1)
